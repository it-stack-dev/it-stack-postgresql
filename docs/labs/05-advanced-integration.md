# Lab 03-05 — Advanced Integration

**Module:** 03 — PostgreSQL primary database  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-03-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect postgresql to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 03-01 through 03-04 pass
